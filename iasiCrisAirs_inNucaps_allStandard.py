...
def readProfileH5(filename,nprofiles):
    h5 = h5py.File('../rttov_test/profile-datasets-hdf/standard101lev_allgas.H5')
    nprofiles = 6 
    groups = []
...
if __name__ == '__main__':
    ...
    chan_list_fsr  = fsrH5['idxNucapsOzoneInInstrument']
    chan_list_cris = crisH5['idxNucapsOzoneInInstrument'] 
    chan_list_iasi = iasiH5['idxNucapsOzoneInInstrument']
    chan_list_airs = airsH5['idxNucapsOzoneInInstrument']
